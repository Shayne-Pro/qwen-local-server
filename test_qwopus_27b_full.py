#!/usr/bin/env python3
"""完整测试 Qwopus3.5-27B-v3 GGUF API 服务 - 流式输出版本"""
...
def test_qwopus_27b_full():
    """完整测试 Qwopus3.5-27B-v3 GGUF API 服务 - 流式输出"""
    ...
    print("Qwopus3.5-27B-v3 GGUF API 服务完整测试 (流式输出)")
    print("=" * 60)
